...
<span class="usertype">【登录角色：<s:property value="#session.user.sysPositionByPositionId.nameCn"/>】</span><s:property value="#session.user.name"/>你好！欢迎访问青鸟办公管理系统！<span style="margin-left:50px;"><a href="${pageContext.request.contextPath }/loginOutSysEmployeeAction.action">退出</a></span></div></div>
    ...
    <div class="action">
    	<div class="t">查看报销单</div>
   		<div class="pages">
                ...
                <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base" style="border-bottom: 1px solid gray;">
                  ...
                  <tr>
                    ...
                    <td>填写人：<s:property value="claim.sysEmployeeByCreateSn.name"/></td>
                   	<td>部门：<s:property value="claim.sysEmployeeByCreateSn.sysDepartment.name"/></td>
                   	<td>职位：<s:property value="claim.sysEmployeeByCreateSn.sysPosition.nameCn"/></td>
                  </tr>
                  <tr>
                ...
                <!-- 审核情况 -->
                <s:if test="claim.bizCheckResults.size>0">
                <p>&nbsp;</p>
	                <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-item" style="border-bottom: 1px solid gray;">
	                  <s:iterator value="claim.bizCheckResults">
	                  	<tr>
	                  		<td>审 批 人：<s:property value="sysEmployee.name"/>(<s:property value="sysEmployee.sysPosition.nameCn"/>)</td>
