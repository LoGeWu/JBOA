...
<a href="loginOutSysEmployeeAction.action">退出</a></span></div></div>
<div class="main"><div class="global-width">
	...
	<div class="nav" id="nav">
    	...
    	<dl class="open" style="height:240px;">
            ...
            <dd><a href="claim_listBySelf.action" target="_self">审核报销单</a></dd>
        </dl>
    </div>
    <div class="action">
    	<div class="t">审核报销单</div>
   		<div class="pages">
                ...
                <p>&nbsp;</p>
	                <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-item" style="border-bottom: 1px solid gray;">
	                  <s:iterator value="claim.bizCheckResults">
	                  	<tr>
	                  		<td>审 批 人：<s:property value="sysEmployee.name"/>(<s:property value="sysEmployee.sysPositionByPositionId.nameCn"/>)</td>
                ...
                <s:if test="#session.user.sysPositionByPositionId.id==2"><!-- 部门经理审批处理 -->
                	<form action="check1ClaimAction.action" method="post">
                </s:if>
                <s:elseif test="#session.user.sysPositionByPositionId.id==3"><!-- 总经理审批处理 -->
                	<form action="check1ClaimAction.action" method="post">
                </s:elseif>
                <s:else><!-- 财务审批处理 -->
                	<form action="check2ClaimAction.action" method="post">
                </s:else>
                 <p>&nbsp;</p>
