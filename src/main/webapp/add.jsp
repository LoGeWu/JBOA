...
<div class="status"><div class="global-width"><span class="usertype">【登录角色：<s:property value="#session.user.sysPositionByPositionId.nameCn"/>】</span><s:property value="#session.user.name"/>你好！欢迎访问青鸟办公管理系统！<span style="margin-left:50px;"><a href="${pageContext.request.contextPath }/loginOutSysEmployeeAction.action">退出</a></span></div></div>
<div class="main"><div class="global-width">
    ...
    <div class="action">
    	<div class="t">增加报销单</div>
   		<div class="pages">
        	<!--增加报销单 区域 开始-->
               <form id="form1" name="form1" method="post" action="addClaimAction.action">
                 <input type="hidden" name="hidd" id="hidd"/>
                 <input type="hidden" name="json" id="json"/>
                <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-base">
                  <caption>基本信息</caption>
                  <tr>
                    <td>填写人：<input value="<s:property value="#session.user.name"/>" readonly="readonly" /></td>
...
<%--						<td>填报时间：<input name="claim.createTime" id="bgclock" readonly="readonly"/><span id="bgclock"></span></td>--%>
                  ...
                  <tr>
                  	<td>总金额：￥<span id="money">0</span>
                        <input type="hidden" name="claim.totalAccount"  value="0" id="totalAccount"> </td>
                  </tr>
                </table>
                <p>&nbsp;</p>
