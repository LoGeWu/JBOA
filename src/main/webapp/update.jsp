	...
	$(".write").live("click",function(){
		...
		$(this).toggle(function(){
			...
			if(b){
				...
				var money=$("#money").html();
<%--				var jiner=$("#jiner").html();--%>
<%--				$("#money").html(parseInt(money)-parseInt(value2)+parseInt(jiner));--%>
   		...
   		<div class="pages">
        	<!--增加报销单 区域 开始-->
                ...
                <table width="90%" border="0" cellspacing="0" cellpadding="0" class="addform-item">
                	<tbody id="main">
                	<form id="form1" name="form1" method="post" action="updClaimAction.action">
                 	<input type="hidden" name="hidd" id="hidd"/>
                 	<input type="hidden" name="json" id="json"/>
                     <input type="hidden" name="claim.totalAccount" id="totalAccount"/>
